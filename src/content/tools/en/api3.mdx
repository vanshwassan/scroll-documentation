---
name: "API3"
category: ["Oracles", "Defi"]
excerpt: ""
logo: { src: "https://cryptologos.cc/logos/api3-api3-logo.png", alt: "API3 Logo" }
website: "https://market.api3.org/scroll"
network: ["Mainnet", "Testnet"]
---

The [API3 Market](https://market.api3.org/scroll) provides access to 200+ price feeds on [Scroll Mainnet](https://market.api3.org/scroll) and [Testnet](https://market.api3.org/scroll-sepolia-testnet). The price feeds operate as a native push oracle and can be activated instantly via the Market UI.
...
- [Use dAPIs on the API3 Market](https://docs.api3.org/guides/dapis/subscribing-to-dapis/)
